...
describe('Test a class TwitterRSSFeed', () => {
  ...
  test('Call statuses_user_timeline', async () => {
    ...
    await trf.statuses_user_timeline(params, info).then(async (rss) => {
      ...
      expect(feed.items[0].title).toEqual('niwasawa \u8ff7\u5b50 (@niwasawa) on Twitter: "test: more than 140 characters. test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,test,xyz" / Twitter');
    }).catch((error) => {
      console.log(error);
    });;
  });
  ...
  describe('Call favorites_list', () => {
    ...
    test('Call favorites_list', async () => {
      ...
      await trf.favorites_list(params, info).then(async (rss) => {
        const parser = new Parser();
        const feed = await parser.parseString(rss);
        expect(feed.items[0].title).toEqual('maigolab_test (@maigolab_test) on Twitter: "TEST: more than 140 characters. TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,ZZZ" / Twitter');
      }).catch((error) => {
        console.log(error);
      });;
    });
  ...
  test('Call search_tweets', async () => {
    ...
    await trf.search_tweets(params, info).then(async (rss) => {
      const parser = new Parser();
      const feed = await parser.parseString(rss);
      expect(feed.items[0].title).toEqual('niwasawa \u8ff7\u5b50 (@niwasawa) on Twitter: "search_test_maigolab: more than 140 characters. search test maigolab,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,ZZZZZZ" / Twitter');
    }).catch((error) => {
      console.log(error);
    });;
  });
  ...
  describe('Call _make_rss', () => {
    ...
    test('For statuses_user_timeline', async () => {
      ...
      // title
      expect(feed.items[1].title).toEqual('niwasawa \u8ff7\u5b50 (@niwasawa) on Twitter: "RT @maigolab_test: TEST: more than 140 characters. TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,TEST,XYZ" / Twitter');
      // link
